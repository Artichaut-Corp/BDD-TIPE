...
public:
    static std::variant<TypedColumn, Errors::Error> DB_GetColumn(int fd, DBTableIndex* Index, const std::string& table_name, const std::string& column_name);
    ...
    static std::variant<std::vector<DbKey>, Errors::Error> DB_GetValuesIndices(int fd, DBTableIndex* Index, const std::string& table_name, const std::string& column_name, Column values);

...
std::vector<size_t> merge_sorted_unique(const std::vector<size_t>& a, const std::vector<size_t>& b)
{
...
void Table::Projection(const std::vector<Database::Querying::Predicat_list> preds, const std::vector<std::string> nom_colonnes) // peut être opti
{

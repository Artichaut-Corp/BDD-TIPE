...
public:
    ...
    struct Node {
        ...
        void SerializeLeaf(int fd) const
        {
            ...
            offset = lseek(fd, (N - 1 - m_Keys.size()) * m_ElementSize, SEEK_CUR);

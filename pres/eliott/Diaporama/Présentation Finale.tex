...
\title[Optimisation du plan et de l’exécution de requêtes SQL]{Comment optimiser l'exécution d'une requête SQL à l'aide de l'algèbre relationnelle ?}
\author{EliottP}
\date{2025 -- 2026}
...
\subsection{Grand jeu de donnée}
\begin{frame}
...
\begin{frame}
    ...
    \begin{itemize}
        ...
        \item La compression des données : \textit{C-Store} \(4\) manière de compresser les données
...
\begin{frame}
    \frametitle{Résumé}
    \begin{itemize}
        \item Différentes optimisations naïves utilisant l'algèbre relationnelle : Descente de sélection et insertion de projection
...
\begin{frame}
    ...
    \begin{itemize}
        ...
        \item Une meilleure organisation des données en mémoire 
...
\begin{frame}{Notre gestion des tables durant l'exécution}
